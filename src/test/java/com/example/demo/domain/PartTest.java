...
class PartTest {
    ...
    void testDate() {
        ...
        partIn.setDate(date);
        assertEquals(date, partIn.getDate());
        partOut.setDate(date);
        assertEquals(date, partOut.getDate());
    ...
    void testStoreNum() {
        int storeNum = 0;
        partIn.setStoreNumber(storeNum);
        assertEquals(storeNum, partIn.getStoreNumber());
        partOut.setStoreNumber(storeNum);
        assertEquals(storeNum, partOut.getStoreNumber());
    }
